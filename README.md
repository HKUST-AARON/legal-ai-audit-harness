...
| Qualified-output source-chain attacks | 270 | Mutates locators, output-source links, procedural source tags, high-authority recall and counter-material recall across all qualified packets; current result is 270/270 downgrade or withdrawal. |
