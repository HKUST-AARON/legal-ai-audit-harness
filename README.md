...
| Substitute-theory falsification | 6 theories | Reports false-positive and false-negative counts for performance sufficiency, source-label sufficiency, authority-material sufficiency, review-label sufficiency, score sufficiency and model-identity sufficiency; current full-protocol false positives and false negatives are 0. |
...
| Construct-operationalization coverage | 41 | Maps 10 core paper constructs to committed evidence layers; current result is 41/41 checks passed across 32 evidence layers. |
| Threat-model coverage | 33 | Maps 8 validity threats to 31 committed evidence layers; current result is 33/33 coverage checks passed. |
...
The construct-operationalization layer adds 41 checks across 10 core paper constructs, linking status ordering, role caps, audit-vector coding, source-chain evidence, authority hierarchy, counter-material salience, contestability/adoption, substitute-theory separation, portability and replication to committed evidence layers.

The threat-model coverage layer adds 33 threat-model coverage checks across 8 validity threats, linking construct, internal, source-chain, external, architecture, policy, provenance and annotation validity to independent evidence layers.
