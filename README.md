...
| Proof-carrying status certificates | 8118 | Generates proof-carrying status certificates for all 246 packets and replays scenario hash, policy hash, score gate, role cap, failure cap, metric bundle, proof obligations and derivation hash. |
