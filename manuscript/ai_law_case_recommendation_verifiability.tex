...
Substitute-rule failure generalizes across strata & Multi-axis holdout generalization & A substitute rule selected outside a held-out issue, suite, role, profile, status or origin stratum reproduces the full protocol inside that stratum. \\
