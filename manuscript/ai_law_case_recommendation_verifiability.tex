...
Metric statistical robustness & 2,000 resamples & Bootstrap CI for recall-threshold precision 0.19--0.32; permutation $p=0.558$ & Tests whether the retrieval/status separation is stable under resampling and label permutation. \\
