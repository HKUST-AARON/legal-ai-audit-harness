...
Normative material screening output & $S,Q,H,K,T,L\geq1$ and $B_A,B_E,B_P,B_C,B_J,B_T,B_F=1$ & Total score $\sum \mathcal{A}(o)\geq9$; authority set, evidence packet, source tags, counter-materials, jurisdiction assumptions, review gate and contestability channel are present. \\
...
The complete evaluation matrix adjudicates one rule: procedural status follows the legal-material chain. It contains 264 scenario packets with 697 embedded records or outputs and 3,664,553 validation operations across public-output, model-output, cross-engine, identity-substitution, invariant, status-lattice, adversarial, ablation, mutation, review-provenance, replay, certificate, query, ranking and coding-robustness layers. Public-output and holdout layers test real upstream outputs. Model-output and repair layers test whether the same fluent authority recommendations change status when source support, counter-material salience and adoption gates change. Cross-engine and model-identity layers test the sharper claim: holding the legal-material chain fixed, provider identity adds no procedural status. Metric, baseline, invariant, lattice, review-provenance and identity-substitution layers test six rival theories--performance sufficiency, source-label sufficiency, authority-material sufficiency, review-label sufficiency, score sufficiency and model-identity sufficiency. Attack, challenge, replay, mutation and tamper layers test whether any broken link destroys qualification.
...
Formal invariant verification & 51,644 checks & 51,644/51,644 & Exhaustive generated states test monotonicity, authority-set necessity, evidence-packet necessity, counter-material necessity, contestability-channel necessity, adoption gates, role caps, failure caps and metric non-equivalence. \\
