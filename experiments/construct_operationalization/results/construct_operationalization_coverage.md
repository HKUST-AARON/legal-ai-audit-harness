...
Core constructs: 10
Evidence layers: 31
Coverage checks: 40/40 passed
Minimum layers per construct: 4
Minimum evidence roles per construct: 3

| Construct | Evidence layers | Evidence roles | Checks |
| --- | ---: | ---: | ---: |
| Procedural status ordering | 4 | 6 | 4/4 |
| System-role and failure caps | 4 | 8 | 4/4 |
| Six-part audit-vector coding | 4 | 6 | 4/4 |
| Output evidence packet and source chain | 4 | 6 | 4/4 |
