...
| Gate family | Occurrences in minimal frontiers |
| --- | ---: |
| audit_vector_completion | 33 |
...
| Target status | Blocked claims |
| --- | ---: |
| decision_support_reason | 15 |
| normative_material_screening_output | 161 |
