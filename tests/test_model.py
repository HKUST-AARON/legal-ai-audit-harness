...
class AuditModelTest(unittest.TestCase):
    ...
    def test_status_certificate_validation_runs(self):
        ...
        self.assertEqual(payload["replay_check_count"], 5658)
        self.assertEqual(payload["passed_check_count"], 5658)
        self.assertEqual(payload["proof_obligation_count"], 4182)
        self.assertEqual(payload["passed_proof_obligation_count"], 4182)
    ...
    def test_policy_constants_replay_runs(self):
        ...
        self.assertEqual(payload["check_count"], 4428)
        self.assertEqual(payload["passed_check_count"], 4428)
    ...
    def test_full_validation_report_shape(self):
        ...
        self.assertEqual(report["suite_count"], 34)
        ...
        self.assertEqual(report["status_certificate_replay_checks"], 5658)
        self.assertEqual(report["validation_units"]["status_certificate_replay_checks"], 5658)
        self.assertEqual(report["status_certificate_proof_obligations"], 4182)
        self.assertEqual(report["validation_units"]["status_certificate_proof_obligations"], 4182)
        self.assertEqual(report["validation_units"]["status_certificate_proof_obligations_passed"], 4182)
        ...
        self.assertEqual(report["policy_constants_replay_checks"], 4428)
        self.assertEqual(report["validation_units"]["policy_constants_replay_checks"], 4428)
        self.assertEqual(report["validation_units"]["policy_constants_replay_passed"], 4428)
        ...
        self.assertEqual(report["blocked_reason_distribution"]["authority_omission"], 869)
        self.assertEqual(report["blocked_reason_distribution"]["contestation_failure"], 55)
        self.assertEqual(report["blocked_reason_distribution"]["counter_material_suppression"], 945)
        self.assertEqual(report["blocked_reason_distribution"]["jurisdiction_assumption_gap"], 54)
        self.assertEqual(report["blocked_reason_distribution"]["source_attribution_gap"], 1023)
        self.assertEqual(report["blocked_reason_distribution"]["summary_distortion"], 1317)
        ...
        self.assertEqual(report["source_chain_attacks"]["status_distribution"]["reference_information"], 378)
        self.assertEqual(report["source_chain_attacks"]["status_distribution"]["no_external_legal_effect"], 1296)
        self.assertEqual(report["source_chain_attacks"]["disposition_distribution"]["downgrade"], 54)
        self.assertEqual(report["source_chain_attacks"]["disposition_distribution"]["suspension"], 324)
        self.assertEqual(report["source_chain_attacks"]["disposition_distribution"]["withdrawal"], 1296)
        ...
        self.assertEqual(report["status_certificate"]["replay_check_count"], 5658)
        self.assertEqual(report["status_certificate"]["passed_check_count"], 5658)
        self.assertEqual(report["status_certificate"]["proof_obligation_count"], 4182)
        self.assertEqual(report["status_certificate"]["passed_proof_obligation_count"], 4182)
        ...
        self.assertEqual(report["policy_constants_replay"]["check_count"], 4428)
        self.assertEqual(report["policy_constants_replay"]["passed_check_count"], 4428)
    ...
    def test_source_chain_attacks_run(self):
        ...
        self.assertEqual(report["summary"]["scenario_count"], 1674)
        self.assertEqual(report["summary"]["expected_passed"], 1674)
        self.assertEqual(report["summary"]["high_upstream_but_blocked"], 1674)
