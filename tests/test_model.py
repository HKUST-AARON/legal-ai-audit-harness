...
class AuditModelTest(unittest.TestCase):
    ...
    def test_full_validation_report_shape(self):
        ...
        self.assertEqual(report["suite_count"], 47)
        ...
        self.assertEqual(report["construct_operationalization_evaluations"], 40)
        self.assertEqual(report["validation_units"]["constructs"], 10)
        self.assertEqual(report["validation_units"]["construct_operationalization_checks"], 40)
        self.assertEqual(report["validation_units"]["construct_operationalization_passed"], 40)
        self.assertEqual(report["construct_operationalization"]["construct_count"], 10)
        self.assertEqual(report["construct_operationalization"]["evidence_layer_count"], 31)
        ...
        self.assertEqual(report["total_evaluation_rows"], 8023761)
