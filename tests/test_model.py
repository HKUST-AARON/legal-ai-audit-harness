...
class AuditModelTest(unittest.TestCase):
    ...
    def test_status_certificate_validation_runs(self):
        ...
        self.assertEqual(payload["replay_check_count"], 5412)
        self.assertEqual(payload["passed_check_count"], 5412)
    ...
    def test_full_validation_report_shape(self):
        ...
        self.assertEqual(report["status_certificate_replay_checks"], 5412)
        self.assertEqual(report["validation_units"]["status_certificate_replay_checks"], 5412)
        ...
        self.assertEqual(report["status_certificate"]["replay_check_count"], 5412)
        self.assertEqual(report["status_certificate"]["passed_check_count"], 5412)
