...
class AuditModelTest(unittest.TestCase):
    ...
    def test_full_validation_report_shape(self):
        ...
        self.assertEqual(report["suite_count"], 48)
        ...
        self.assertEqual(report["construct_operationalization_evaluations"], 41)
        self.assertEqual(report["validation_units"]["constructs"], 10)
        self.assertEqual(report["validation_units"]["construct_operationalization_checks"], 41)
        self.assertEqual(report["validation_units"]["construct_operationalization_passed"], 41)
        self.assertEqual(report["construct_operationalization"]["construct_count"], 10)
        self.assertEqual(report["construct_operationalization"]["evidence_layer_count"], 32)
        self.assertTrue(report["construct_operationalization"]["all_passed"])
        self.assertEqual(report["threat_model_coverage_evaluations"], 33)
        self.assertEqual(report["validation_units"]["validity_threats"], 8)
        self.assertEqual(report["validation_units"]["threat_model_coverage_checks"], 33)
        self.assertEqual(report["validation_units"]["threat_model_coverage_passed"], 33)
        self.assertEqual(report["threat_model_coverage"]["evidence_layer_count"], 31)
        self.assertTrue(report["threat_model_coverage"]["all_passed"])
        self.assertEqual(report["total_evaluation_rows"], 8023954)
