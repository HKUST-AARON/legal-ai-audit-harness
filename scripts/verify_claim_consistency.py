...
def _checks(payload: dict) -> list[dict]:
    ...
    expectations = [
        ...
        ("README.md", f"{values['metric']} metric-separation evaluations, {_comma(values['metric_resamples'])} metric statistical resamples, {_comma(values['baseline_predictions'])} baseline-rule predictions, {values['gate']} gate-ablation evaluations, {values['gate_contrast']} gate-contrast witness pairs, {_comma(values['source_chain'])} source-chain attack variants, {values['contestation']} contestation challenge variants, {_comma(values['metamorphic'])} metamorphic policy tests, {_comma(values['policy_mutation_evaluations'])} policy-mutation evaluations, {values['review_provenance_evaluations']} review-provenance checks, {_comma(values['identity_evaluations'])} model-identity substitutions, {values['query_variants']} query-perturbation variants across {values['query_groups']} issue groups, {values['query_portfolios']} query portfolios plus {values['query_portfolio_groups']} group frontier summaries, {_comma(values['repair'])} repair-frontier evaluations, {values['jurisdiction']} jurisdiction-profile checks, {values['ranking_window']} rank-window visibility checks, {values['ranking_counterfactuals']} rank-order counterfactuals, {_comma(values['certificate_checks'])} status-certificate replay checks, {_comma(values['certificate_obligations'])} certificate proof obligations, {_comma(values['certificate_tamper'])} certificate tamper-resistance cases and {_comma(values['policy_constants_checks'])} policy-constants replay checks"),
