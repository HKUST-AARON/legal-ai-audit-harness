...
def _checks(payload: dict) -> list[dict]:
    ...
    expectations = [
        ...
        ("ARTIFACT.md", f"- score-blinded coding inter-coder minimum dimension kappa {values['blind_min_dimension_kappa']:.2f}, minimum derived failure-flag exact agreement {values['blind_min_failure_flag_exact']:.2f} and minimum derived missing-gate exact agreement {values['blind_min_missing_gate_exact']:.2f}"),
        ...
        ("README.md", f"Current results are inter-coder minimum dimension kappa {values['blind_min_dimension_kappa']:.2f}, minimum derived failure-flag exact agreement {values['blind_min_failure_flag_exact']:.2f} and minimum derived missing-gate exact agreement {values['blind_min_missing_gate_exact']:.2f}."),
        ...
        ("docs/paper_mapping.md", "inter-coder dimension-level, and post-evaluation failure-flag and missing-gate agreement"),
        ...
        ("skills/legal-ai-audit-harness/SKILL.md", f"{values['blind_min_dimension_kappa']:.2f} inter-coder minimum dimension kappa, {values['blind_min_failure_flag_exact']:.2f} minimum derived failure-flag exact agreement, {values['blind_min_missing_gate_exact']:.2f} minimum derived missing-gate exact agreement"),
        ...
        ("manuscript/ai_law_case_recommendation_verifiability.tex", f"Score-blinded dual coding & {values['blind_packets']} packets, {values['blind_passes']} passes & {values['blind_kappa']:.2f} coder kappa; {values['blind_min_dimension_kappa']:.2f} min dimension kappa"),
        ...
        ("experiments/full_validation/results/full_validation_report.md", f"Score-blinded coding: {values['blind_packets']} packets, {values['blind_passes']} coding passes, {values['blind_exact']:.2f} coder-coder exact agreement, {values['blind_kappa']:.2f} coder-coder kappa, {values['blind_weighted_kappa']:.2f} coder-coder weighted kappa, {values['blind_min_dimension_kappa']:.2f} minimum dimension kappa, {values['blind_min_failure_flag_exact']:.2f} minimum derived failure-flag exact agreement, {values['blind_min_missing_gate_exact']:.2f} minimum derived missing-gate exact agreement, {values['blind_base_exact']:.2f} minimum base-coder exact agreement, {values['blind_base_weighted']:.2f} minimum base-coder weighted agreement, {values['blind_base_kappa']:.2f} minimum base-coder kappa, {values['blind_base_weighted_kappa']:.2f} minimum base-coder weighted kappa"),
