...
def _checks(payload: dict) -> list[dict]:
    ...
    expectations = [
        ...
        ("README.md", f"{values['metric']} metric-separation evaluations, {_comma(values['metric_resamples'])} metric statistical resamples, {values['gate']} gate-ablation evaluations, {_comma(values['repair'])} repair-frontier evaluations and {values['jurisdiction']} jurisdiction-profile checks"),
