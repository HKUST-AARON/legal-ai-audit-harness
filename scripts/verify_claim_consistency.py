...
def _checks(payload: dict) -> list[dict]:
    ...
    expectations = [
        ...
        ("manuscript/ai_law_case_recommendation_verifiability.tex", f"{_comma(values['certificate_obligations'])} certificate proof obligations"),
        ("manuscript/ai_law_case_recommendation_verifiability.tex", f"{_comma(values['certificate_tamper'])} certificate tamper-resistance cases"),
        ...
        ("manuscript/ai_law_case_recommendation_verifiability.tex", f"{values['certificates_verified']}/{values['certificate_count']} proof-carrying status certificates"),
