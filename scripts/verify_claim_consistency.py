...
def _checks(payload: dict) -> list[dict]:
    ...
    expectations = [
        ...
        ("manuscript/ai_law_case_recommendation_verifiability.tex", f"Score-blinded dual coding & {values['blind_packets']} packets, {values['blind_passes']} passes & {values['blind_kappa']:.2f} coder kappa; {values['blind_base_kappa']:.2f} min base kappa"),
        ...
        ("experiments/full_validation/results/full_validation_report.md", f"Score-blinded coding: {values['blind_packets']} packets, {values['blind_passes']} coding passes, {values['blind_exact']:.2f} coder-coder exact agreement, {values['blind_kappa']:.2f} coder-coder kappa, {values['blind_weighted_kappa']:.2f} coder-coder weighted kappa, {values['blind_base_exact']:.2f} minimum base-coder exact agreement, {values['blind_base_weighted']:.2f} minimum base-coder weighted agreement, {values['blind_base_kappa']:.2f} minimum base-coder kappa, {values['blind_base_weighted_kappa']:.2f} minimum base-coder weighted kappa"),
