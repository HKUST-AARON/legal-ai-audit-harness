...
def _checks(payload: dict) -> list[dict]:
    ...
    expectations = [
        ...
        ("README.md", f"{values['metric']} metric-separation evaluations, {values['gate']} gate-ablation evaluations and {_comma(values['repair'])} repair-frontier evaluations"),
        ...
        ("manuscript/ai_law_case_recommendation_verifiability.tex", f"{_comma(values['formal'])} formal invariant checks, {values['metric']} metric-separation evaluations, {values['gate']} gate-ablation evaluations and {_comma(values['repair'])} repair-frontier counterfactuals"),
